...
| `MAX_REVIEW_SECONDS` | `int` | `300` | Maximum wall-clock time for the full review (all agents + synthesis), in seconds (min: 10) |
...
| Setting | Type | Default | Description |
|---------|------|---------|-------------|
| `LOG_LEVEL` | `LogLevel` | `INFO` | Application log level: `DEBUG`, `INFO`, `WARNING`, `ERROR` |
